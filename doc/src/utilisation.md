...
7. Région d'inclusion. Le volume grisé représente la zone dans laquelle les points seront conservés. Il est possible d'obtenir un gizmo sur cette zone en cliquand sur les poignées
...
Si des caméra orbbec sont branchées sur votre réseau, le menu déroulant "IP" devrait déjà contenir les adresses IP des caméras. Si vous venez de les brancher, attendez un moment que les orbbecs démarrent et que le processus d'auto-découverte de Carto les trouve.
